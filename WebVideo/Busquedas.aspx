...
<asp:Content ID="Content1" ContentPlaceHolderID="Cuerpo" runat="server">
    ...
    <asp:TextBox ID="SerieBox" runat="server"  OnTextChanged="TextBox1_TextChanged" Width="926px"></asp:TextBox>
    <br />
    ...
    <asp:Button ID="Btn_Serie2" runat="server" Text="Mostrar Pelicula" OnClick="Btn_Serie2C" Visible="False" />
    ...
    <asp:TextBox ID="ActorBox" runat="server" OnTextChanged="TextBox1_TextChanged" Width="926px"></asp:TextBox>
    <br />
    ...
    <asp:TextBox ID="DirectorBox" runat="server" OnTextChanged="TextBox1_TextChanged" Width="926px"></asp:TextBox>
    <br />
